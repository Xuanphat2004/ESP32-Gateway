...
const rows = [
  ...
  },
  {
    ...
    site: "Fu Luh",
    year: 2022,
    jan: 133349.90, feb: 155498.60, mar: 177985.60, apr: 155568.25, may: 149896.75, jun: 133051.40,
    jul: 139508.95, aug: 143419.30, sep: 128305.25, oct: 137737.85, nov: 128165.95, dec: 133170.80,
    updatedBy: "kaifong.lim",
    updatedOn: "2025-08-25",
  },
    ...
    <Box sx={{ 
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2 }}>
        <Typography variant="h5" sx={{ fontWeight: "bold", color: theme.palette.mode === 'dark' ? '#80cbc4' : '#00695c' }}>
          Grid-inject Budget Input  {/* Đổi tên tiêu đề cho đúng trang */}
        </Typography>
      ...
      <TableContainer component={Paper} sx={{ 
          backgroundColor: theme.palette.mode === 'dark' ? "#ddb224ff" : "#283593", // Màu nền bảng
          borderRadius: 1,
        ...
        <Table sx={{ minWidth: 1200 }} aria-label="budget grid table" size="small">
          ...
          {/* Table Head */}
          <TableHead>
            <TableRow sx={{ backgroundColor: theme.palette.mode === 'dark' ? "#263238" : "#eeeeee" }}>
...
export default BudgetGridInjectInput;