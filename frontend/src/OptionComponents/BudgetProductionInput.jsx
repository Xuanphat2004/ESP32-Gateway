...
const rows = [
  ...
  },
  {
  ...
  },
   {
    ...
    site: "Fu Luh",
    year: 2023,
    jan: 132679.80, feb: 154717.20, mar: 177091.20, apr: 154786.50, may: 149143.50, jun: 132382.80,
    jul: 138807.90, aug: 142698.60, sep: 127660.50, oct: 137045.70, nov: 127521.90, dec: 132501.60,
    updatedBy: "kaifong.lim",
    updatedOn: "2025-08-25",
  },
  {
    ...
    site: "Fu Luh",
    year: 2022,
    jan: 133329.90, feb: 155498.60, mar: 177985.60, apr: 155568.25, may: 149896.75, jun: 133051.40,
    jul: 139508.95, aug: 143419.30, sep: 128345.25, oct: 137737.85, nov: 123235.95, dec: 133170.80,
    updatedBy: "kaifong.lim",
    updatedOn: "2025-08-25",
  },
  {
    ...
    site: "Fu Luh",
    year: 2021,
    jan: 134020.00, feb: 156280.00, mar: 178845.00, apr: 156350.00, may: 150650.00, jun: 133720.00,
    jul: 140210.00, aug: 144140.00, sep: 128950.00, oct: 138430.00, nov: 123210.00, dec: 131340.00,
    updatedBy: "kaifong.lim",
    updatedOn: "2025-08-25",
  },
];
    ...
    <Box sx={{ 
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2 }}>
        <Typography variant="h5" sx={{ fontWeight: "bold", color: theme.palette.mode === 'dark' ? '#80cbc4' : '#00695c' }}>
          Production Budget Input  {/* Đổi tên tiêu đề cho đúng trang */}
        </Typography>
      ...
      <TableContainer component={Paper} sx={{ 
          backgroundColor: theme.palette.mode === 'dark' ? "#000000ff" : "#fff", // Màu nền bảng
          borderRadius: 1,
              ...
              <TableRow
                ...
                sx={{ 
                    ...
                    backgroundColor: index % 2 === 0 
                        ? (theme.palette.mode === 'dark' ? "#1e2a30" : "#fff") 
                        : (theme.palette.mode === 'dark' ? "#232f34" : "#f5f5f5"),
...
export default BudgetProductionInput;